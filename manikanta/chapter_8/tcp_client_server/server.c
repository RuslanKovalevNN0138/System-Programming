...
int main()
{
    ...
    if(connection_status == -1){
        printf("Socket is unable to listen for new connection.\n");
        exit(1);
    }
    else printf("Server is listenning for new connnection: \n");
    ...
    while(1){
        ...
        printf("Data receivedfrom client: %s\n", message);
        bzero(message, MESSAGE_LENGTH);
        ...
        if(bytes >=0){
            printf("Data successfuly sent to the client!\n");
        }
    }
